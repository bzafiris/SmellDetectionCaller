...
public class TraditionBreakerDetection extends AbstractDesignSmellDetection implements IDesignSmellDetection {
	...
	public void detect(final IAbstractLevelModel anAbstractLevelModel) {
		...
		final Set setParentClass = this.operators.intersection(setNoInheritance, setHasChildren);
		...
		final Set setLargeParentClass = this.operators.intersection(setLargeClass, setParentClass);
